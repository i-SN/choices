...
// nouvelle page :
class Choix4 extends StatefulWidget {

  List<int> numeroligne=[69,70,71,72,73,74,75,76,77,78,79]; // numéro des paragraphe
  final String nom; // nom du personnage
  bool sexe;
Choix4(this.nom, this.sexe){
...
// construction de la classe : //
  @override 
  State createState() => new Choix4State(this.nom);
}

class Choix4State extends State<Choix4> {
              ...
              child :
                new ListView( // scroll
                    ...
                    children: <Widget>[
                      ...
                      text:new TextSpan(
                      children: <TextSpan>[
                        dialoguepage[69].texte,
                        dialoguepage[70].texte,
                        dialoguepage[71].texte,
                        dialoguepage[72].texte,
                        dialoguepage[73].texte,
                        dialoguepage[74].texte,
                        dialoguepage[75].texte,
                        dialoguepage[76].texte,
                        dialoguepage[77].texte,
                        dialoguepage[78].texte,
                        dialoguepage[79].texte,
                          ], 
                        )
                        ),
                        ],
