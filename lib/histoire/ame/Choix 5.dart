...
// nouvelle page :
class Choix5 extends StatefulWidget {

  List<int> numeroligne=[80,81,82,83,84,85,86,87]; // numéro des paragraphe
  final String nom; // nom du personnage
  bool sexe;
Choix5(this.nom, this.sexe){
...
// construction de la classe : //
  @override 
  State createState() => new Choix5State(this.nom);
}

class Choix5State extends State<Choix5> {
              ...
              child :
                new ListView( // scroll
                    ...
                    children: <Widget>[
                      ...
                      text:new TextSpan(
                      children: <TextSpan>[
                        dialoguepage[80].texte,
                        dialoguepage[81].texte,
                        dialoguepage[82].texte,
                        dialoguepage[83].texte,
                        dialoguepage[84].texte,
                        dialoguepage[85].texte,
                        dialoguepage[86].texte,
                        dialoguepage[87].texte,
                          ], 
                        )
                        ),
                        ],
