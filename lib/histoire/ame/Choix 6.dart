...
// construction de la classe : //
  @override 
  State createState() => new Choix6State(this.nom);
}

class Choix6State extends State<Choix6> {
              ...
              child :
                new ListView( // scroll
                    ...
                    children: <Widget>[
                      ...
                      text:new TextSpan(
                      children: <TextSpan>[
                        dialoguepage[88].texte,
                        dialoguepage[89].texte,
                        dialoguepage[90].texte,
                        dialoguepage[91].texte,
                        dialoguepage[92].texte,
                          ], 
                        )
                        ),
                        ],
