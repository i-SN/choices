...
int numero=11; // numero de la page choix
List<Texte> dialoguepage=[]; // Liste de Texte
int ligne;


// nouvelle page :
class Choix11 extends StatefulWidget {

  List<int> numeroligne=[152,153,154,155,156,157,158,159]; // numéro des paragraphe
  final String nom; // nom du personnage
  bool sexe;
Choix11(this.nom, this.sexe){
...
// construction de la classe : //
  @override 
  State createState() => new Choix11State(this.nom);
}

class Choix11State extends State<Choix11> {
