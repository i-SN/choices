...
int numero=13; // numero de la page choix
List<Texte> dialoguepage=[]; // Liste de Texte
int ligne;


// nouvelle page :
class Choix13 extends StatefulWidget {

  List<int> numeroligne=[189,190,191,192,193,194,195,196,197,198,199,200,201,202]; // numéro des paragraphe
  final String nom; // nom du personnage
  bool sexe;
Choix13(this.nom, this.sexe){
  dialogue=[];
...
// construction de la classe : //
  @override 
  State createState() => new Choix13State(this.nom);
}

class Choix13State extends State<Choix13> {
