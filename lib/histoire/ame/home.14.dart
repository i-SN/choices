...
int numero=14; // numero de la page choix
List<Texte> dialoguepage=[]; // Liste de Texte
int ligne;


// nouvelle page :
class Choix14 extends StatefulWidget {

  List<int> numeroligne=[203,204,205,206,207,208,209,210,211,212,213,214,215,216,217,218,219,220,221,222,223,224,225,226,227,228,229,230,231,232,233,234,235]; // numéro des paragraphe
  final String nom; // nom du personnage
  bool sexe;
Choix14(this.nom, this.sexe){
  dialogue=[];
...
// construction de la classe : //
  @override 
  State createState() => new Choix14State(this.nom);
}

class Choix14State extends State<Choix14> {
